...
int do_main(int argc, char* argv[]) {
  ...
  std::vector<DircolKinematicData<double>*> constraints;
  constraints.push_back(&constraint);
  constraints.push_back(&constraint2);
  auto dataset = DircolKinematicDataSet<double>(tree, &constraints);
  ...
  //TODO: add tests for constraint set and dircoldynamicconstraint, probably should make these constraints more than just a does-run check (check values)
