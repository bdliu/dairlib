#include "examples/Goldilocks_models/dynamics_constraint_at_tail.h"


namespace dairlib {
namespace goldilocks_models {

DynamicsConstraintAtTail::DynamicsConstraintAtTail(
  ...
  DynamicsExpression expression_object_(n_sDDot, n_feature_sDDot);
...
void DynamicsConstraintAtTail::DoEval(const
...
VectorXd DynamicsConstraintAtTail::getGradientWrtTheta(
...
AutoDiffVecXd DynamicsConstraintAtTail::getDynamicsConstraint(
...
VectorXd DynamicsConstraintAtTail::getDynamicsConstraint(
  const VectorXd & s_i, const VectorXd & s_iplus1,
